...
final class DefaultApplicationSettings
{
    /**
     * @return list<array{key: string, value: string, group: string, type: string, description: string}>
     */
    public static function all(): array
    {
        return [
            ...
            [
                'key' => 'app.name',
                'value' => (string) config('app.name', 'PasPapan'),
                'group' => 'identity',
                'type' => 'text',
            ...
            [
                ...
                'value' => (string) (config('app.enterprise_license_key') ?: ''),
                'group' => 'enterprise',
                'type' => 'textarea',
