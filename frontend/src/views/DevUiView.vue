  ...
  <div class="mx-auto max-w-4xl space-y-8 p-6">
    ...
    <section class="space-y-3">
      ...
      <div class="grid gap-4 sm:grid-cols-2">
        ...
        <AppInput v-model="text" label="Email" type="email" error="Format email tidak valid" />
        <AppSelect
          v-model="division"
          label="Divisi"
    ...
    <section class="space-y-3">
      ...
      <AppEmptyState title="Tidak ada pengajuan" description="Semua pengajuan sudah diproses" />
