        ...
        >
            ...
            <div class="fixed inset-0 z-10 overflow-y-auto">
                <div class="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    <div class="relative transform overflow-hidden rounded-2xl bg-white text-left shadow-xl transition-all ring-1 ring-slate-900/5 dark:bg-slate-900 dark:ring-white/10 sm:my-6 sm:w-full sm:max-w-2xl" @click.away="!@js(($announcement->modal_behavior ?? 'acknowledge') === 'acknowledge') && $wire.dismiss()">
                            ...
                            <div class="flex flex-col justify-between gap-3 sm:flex-row sm:items-center">
                                <label class="group relative flex cursor-pointer items-center gap-3">
                                    <div class="relative flex items-center justify-center">
                                        <input type="checkbox" x-model="acknowledged" class="peer h-5 w-5 cursor-pointer appearance-none rounded-md border-2 border-slate-300 bg-white transition-all checked:border-rose-600 checked:bg-rose-600 hover:border-rose-500 dark:border-slate-600 dark:bg-slate-800 dark:checked:border-rose-500 dark:checked:bg-rose-500 dark:hover:border-rose-400">
