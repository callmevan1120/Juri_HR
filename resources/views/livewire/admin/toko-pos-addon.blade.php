...
>
    ...
    <div data-toko-addon-flag="toko_pos" data-toko-nav-addon-flag="toko_pos" class="hidden"></div>
        ...
        <x-admin.page-tools grid-class="grid grid-cols-1 items-end gap-3 lg:grid-cols-12">
            ...
            <div class="lg:col-span-8 flex justify-end">
                <div class="flex w-full items-center gap-1 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 rounded-xl bg-slate-100  p-1.5 text-sm font-bold dark:bg-slate-800 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-inner">
                    @foreach ($tokoNavigation as $nav)
                        <a href="{{ $nav['href'] }}" @class([
                            'shrink-0 rounded-lg px-4 py-3 transition-all duration-200 text-center flex-1 min-w-[max-content]',
    ...
    @if ($activePage === 'dashboard')
        <x-admin.panel class="overflow-hidden">
                ...
                <section class="p-2">
                    ...
                    <div class="grid gap-2 sm:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-5">
                        @foreach ($summary as $item)
                            <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-gradient-to-br from-slate-50 to-white p-3 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition-all duration-300 dark:from-slate-900/80 dark:to-slate-950 dark:border-slate-700/50/80 dark:bg-slate-950/60">
            ...
            @if (($dashboardOverview['stock_kpis'] ?? []) !== [] || ($dashboardOverview['profit_kpis'] ?? []) !== [])
                <div class="divide-y divide-slate-200 border-t border-slate-200/60/80 dark:divide-slate-700 dark:border-slate-700/50/80">
            ...
            <div class="mt-3 grid gap-2 xl:grid-cols-2">
                <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
                    <div class="border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
                        <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">5 Barang dengan Stok paling banyak</h2>
                    </div>
                    <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
            ...
            <div class="mt-3">
                <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
                    <div class="flex flex-col gap-1 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                        <div>
    ...
    @if ($activePage === 'products')
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:grid-cols-2 xl:grid-cols-5">
                @foreach ($productWorkspaceTabs as $tab)
                    <button
                        ...
                        class="min-h-12 rounded-xl border px-4 py-3.5 text-left transition {{ $productWorkspace === $tab['key'] ? 'border-primary-500 bg-primary-50 text-primary-800 dark:border-primary-500 dark:bg-primary-950/30 dark:text-primary-100' : 'border-slate-200/60/80 bg-white text-slate-700 hover:border-primary-300 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-slate-200 dark:hover:border-primary-600' }}"
                    >
                        <span class="block text-sm font-semibold">{{ $tab['label'] }}</span>
                        <span class="mt-1 block text-xs text-slate-500 dark:text-slate-400 font-medium">{{ $tab['caption'] }}</span>
                    </button>
                @endforeach
            </div>

            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 sm:grid-cols-2 xl:grid-cols-6">
                @foreach ([
            ...
            @if ($productWorkspace === 'create')
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <div class="mb-4 flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">Form Barang</h3>
                        ...
                        <button type="button" wire:click="resetCatalogProductForm" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">
                            <x-heroicon-o-arrow-path class="h-5 w-5" />
                            <span>{{ __('Reset') }}</span>
                        </button>
                    </div>

                    <div class="border-b border-slate-200/60/80 dark:border-slate-700/50/80">
                    ...
                    <div class="mt-3 grid gap-2 lg:grid-cols-4">
                        <input type="text" wire:model="productName" placeholder="{{ __('Product name') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="productSku" placeholder="{{ __('SKU') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="productBarcode" placeholder="{{ __('Barcode') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        ...
                        <input list="toko-brand-options" type="text" wire:model="productBrand" placeholder="{{ __('Brand') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <datalist id="toko-brand-options">
                            @foreach ($productBrandRows as $brand)
                                <option value="{{ $brand['name'] }}"></option>
                            @endforeach
                        </datalist>
                        <input list="toko-category-options" type="text" wire:model="productCategory" placeholder="{{ __('Category') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <datalist id="toko-category-options">
                            @foreach ($productCategoryRows as $category)
                                <option value="{{ $category['name'] }}"></option>
                            @endforeach
                        </datalist>
                        <input type="text" wire:model="productUnit" placeholder="{{ __('Unit') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="productLocation" placeholder="{{ __('Location') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">

                        <input type="text" wire:model="productColor" placeholder="{{ __('Color') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="productSize" placeholder="{{ __('Size') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="date" wire:model="productExpiredAt" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="number" min="0" step="0.001" wire:model="productReorderPoint" placeholder="{{ __('Reorder point') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">

                        <input type="number" min="0" step="0.01" wire:model="productCostPrice" placeholder="{{ __('Cost price') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="number" min="0" step="0.01" wire:model="productSellingPrice" placeholder="{{ __('Selling price') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <button
                            type="button"
                            wire:click="saveCatalogProduct"
                            data-form-action="catalog-product"
                            class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-primary-600 to-primary-500 hover:from-primary-500 hover:to-primary-400 shadow-md hover:shadow-lg transition-all px-4 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-primary-700 lg:col-span-2"
                        >
            ...
            <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                <div class="flex flex-wrap items-center gap-2 text-sm">
	                    ...
	                    <span class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3 text-slate-700 dark:border-slate-700/50/80 dark:text-slate-200">10</span>
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="toko-product-search" type="search" wire:model.live.debounce.250ms="productSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                </div>
            </div>

            @if ($productStockCardDetail)
                <div class="border-b border-slate-200/60/80 bg-slate-50 px-4 py-4 dark:border-slate-700/50/80 dark:bg-slate-900/60">
                    ...
                    <div class="mt-3 grid gap-2 md:grid-cols-4">
                        <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white p-2 dark:border-slate-700/50/80 dark:bg-slate-950">
            ...
            <div class="flex flex-col gap-2 border-t border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap justify-end gap-2">
                    ...
                    @if ($productPageStart > 1)
                        <button type="button" wire:click="gotoProductPage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                    ...
                    @if ($productPageEnd < $productTableMeta['pages'])
                        <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                        <button type="button" wire:click="gotoProductPage({{ $productTableMeta['pages'] }})" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">{{ $idNumber($productTableMeta['pages']) }}</button>
                    @endif
                    <button type="button" wire:click="nextProductPage" @disabled($productTableMeta['page'] >= $productTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
                    ...
                    @if (count($productRows) > 0)
                        <a href="{{ route('admin.toko.products.barcodes', ['products' => collect($productRows)->pluck('id')->take(24)->all()]) }}" target="_blank" aria-label="Print" title="Print" class="wcag-touch-target inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 text-slate-700 dark:border-slate-700/50/80 dark:text-slate-200">
                            <x-heroicon-o-printer class="h-5 w-5" />
                        </a>
                    @else
                        <span aria-label="Print" title="Print" class="wcag-touch-target inline-flex h-10 w-10 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 text-slate-400 opacity-60 dark:border-slate-700/50/80 dark:text-slate-500">
                            <x-heroicon-o-printer class="h-5 w-5" />
                        </span>
                    @endif
                </div>
            ...
            @if ($productWorkspace === 'barcode')
                <div class="grid gap-2 px-4 py-4 lg:grid-cols-[minmax(0,1fr)_380px]">
                    <div>
                        <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">Modul Cetak Barcode</h3>
                        <div class="mt-3 grid gap-2 lg:grid-cols-[minmax(0,1fr)_160px]">
                            ...
                            <input type="number" min="1" max="15" wire:model.live="barcodePrintQuantity" placeholder="{{ __('Jumlah Print') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        </div>
                        @if ($barcodeProductPreview)
                            <div class="mt-3 overflow-hidden rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 dark:border-slate-700/50/80">
                                <div class="grid gap-2 p-3 text-sm sm:grid-cols-4">
                                    <div>
                                        ...
                                        <p class="mt-1 font-bold tracking-tight text-slate-900 dark:text-white">{{ $barcodeProductPreview['name'] }}</p>
                                    </div>
                                    <div>
                                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">SKU</p>
                                        <p class="mt-1 font-mono text-slate-700 dark:text-slate-200">{{ $barcodeProductPreview['sku'] ?: '-' }}</p>
                                    </div>
                                    <div>
                                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">Barcode</p>
                                        <p class="mt-1 font-mono text-slate-700 dark:text-slate-200">{{ $barcodeProductPreview['barcode'] }}</p>
                                    </div>
                                    <div>
                                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">Jumlah</p>
                                        <p class="mt-1 font-bold tracking-tight text-slate-900 dark:text-white">{{ $barcodeProductPreview['quantity'] }}</p>
                                    </div>
                                </div>
                                <div class="border-t border-slate-200/60/80 p-3 dark:border-slate-700/50/80">
                    ...
                    <div class="rounded-xl border border-dashed border-slate-300 p-3 dark:border-slate-700/50/80">
                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Label Preview') }}</p>
            ...
            @if (in_array($productWorkspace, ['categories', 'brands'], true))
                ...
                <div class="px-4 py-4">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ $taxonomyTitle }}</h3>
                        <div class="flex gap-2">
                            <input type="text" wire:model="{{ $taxonomyInput }}" placeholder="{{ $taxonomyPlaceholder }}" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    ...
                    <div class="mt-3 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 dark:border-slate-700/50/80">
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50/50 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:bg-slate-900 dark:text-slate-400">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    <th class="px-4 py-3 text-left">Kode</th>
                                    <th class="px-4 py-3 text-left">Nama</th>
                                    <th class="px-4 py-3 text-right">Barang</th>
                            ...
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                @forelse ($taxonomyRows as $row)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        <td class="px-4 py-3 font-mono text-xs text-slate-600 dark:text-slate-300">{{ $row['code'] }}</td>
                                        <td class="px-4 py-3 font-bold tracking-tight text-slate-900 dark:text-white">{{ $row['name'] }}</td>
                                        <td class="px-4 py-3 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($row['products_count']) }}</td>
                                        <td class="px-4 py-3 text-slate-600 dark:text-slate-300">{{ $row['source'] }}</td>
                                        <td class="px-4 py-3 text-right">
    ...
    @if ($activePage === 'customers')
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Customers') }}</h2>
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-3">
                <input type="text" wire:model="customerCode" placeholder="{{ __('Code') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="text" wire:model="customerName" placeholder="{{ __('Customer name') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <x-forms.tom-select id="toko-customer-status" wire:model="customerStatus" placeholder="{{ __('Status') }}" dropdown-direction="down">
                    <option value="active">{{ __('Active') }}</option>
                    <option value="inactive">{{ __('Inactive') }}</option>
                </x-forms.tom-select>
                <input type="text" wire:model="customerPhone" placeholder="{{ __('Phone') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="email" wire:model="customerEmail" placeholder="{{ __('Email') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                ...
                <textarea wire:model="customerAddress" placeholder="{{ __('Address') }}" class="min-h-20 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white lg:col-span-3"></textarea>
            </div>
            ...
            <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="toko-customer-search" type="search" wire:model.live.debounce.250ms="customerSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                </div>
            </div>
            ...
            <div class="flex flex-col gap-2 border-t border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap justify-end gap-2">
                    <button type="button" wire:click="previousCustomerPage" @disabled($customerTableMeta['page'] <= 1) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Previous</button>
                    @php
                    ...
                    @if ($customerPageStart > 1)
                        <button type="button" wire:click="gotoCustomerPage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                        <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                    @endif
                    ...
                    @endif
                    <button type="button" wire:click="nextCustomerPage" @disabled($customerTableMeta['page'] >= $customerTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
                </div>
            </div>
    ...
    @if ($activePage === 'vendors')
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                <div>
                    <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Vendors') }}</h2>
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-3">
                <input type="text" wire:model="vendorCode" placeholder="{{ __('Code') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="text" wire:model="vendorName" placeholder="{{ __('Vendor name') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <x-forms.tom-select
                ...
                <input type="text" wire:model="vendorPhone" placeholder="{{ __('Phone') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="email" wire:model="vendorEmail" placeholder="{{ __('Email') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                ...
                <textarea wire:model="vendorAddress" placeholder="{{ __('Address') }}" class="min-h-20 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white lg:col-span-3"></textarea>
            </div>
            ...
            <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="toko-vendor-search" type="search" wire:model.live.debounce.250ms="vendorSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                </div>
            </div>

            @if ($vendorApDetail)
                <div class="border-b border-slate-200/60/80 bg-slate-50 px-4 py-4 dark:border-slate-700/50/80 dark:bg-slate-900/50">
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-start sm:justify-between">
                        <div>
                            <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Vendor AP Summary') }}</p>
                            <h3 class="mt-1 text-base font-bold tracking-tight text-slate-900 dark:text-white">{{ $vendorApDetail['name'] }}</h3>
                    ...
                    <div class="mt-3 grid gap-2 md:grid-cols-3">
                        <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white p-2 dark:border-slate-700/50/80 dark:bg-slate-950">
                            <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Total Purchases') }}</p>
                            <p class="mt-1 text-base font-bold tracking-tight text-slate-900 dark:text-white">{{ $idNumber($vendorApDetail['total_purchases']) }}</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white p-2 dark:border-slate-700/50/80 dark:bg-slate-950">
                            <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Open AP') }}</p>
                            <p class="mt-1 text-base font-bold tracking-tight text-slate-900 dark:text-white">{{ $idNumber($vendorApDetail['open_ap']) }}</p>
                        </div>
                        <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white p-2 dark:border-slate-700/50/80 dark:bg-slate-950">
                            <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Paid Total') }}</p>
                            <p class="mt-1 text-base font-bold tracking-tight text-slate-900 dark:text-white">{{ $idNumber($vendorApDetail['paid_total']) }}</p>
                        </div>
                    </div>
                    <div class="mt-3 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white dark:border-slate-700/50/80 dark:bg-slate-950">
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50/50 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:bg-slate-900 dark:text-slate-400">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    <th class="px-4 py-3.5 text-left">{{ __('Recent Purchases') }}</th>
                                    <th class="px-4 py-3.5 text-left">{{ __('Status') }}</th>
                                    <th class="px-4 py-3.5 text-left">{{ __('Due') }}</th>
                                    <th class="px-4 py-3.5 text-right">{{ __('Total') }}</th>
                                    <th class="px-4 py-3.5 text-right">{{ __('Paid') }}</th>
                                    <th class="px-4 py-3.5 text-right">{{ __('Balance') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                @forelse ($vendorApDetail['rows'] as $bill)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        ...
                                        <td class="px-4 py-3.5 text-slate-700 dark:text-slate-200">{{ $bill['due_at'] ?? '-' }}</td>
                                        <td class="px-4 py-3.5 text-right font-semibold text-slate-900 dark:text-slate-100">{{ $idNumber($bill['total']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-700 dark:text-slate-200">{{ $idNumber($bill['paid_total']) }}</td>
                                        <td class="px-4 py-3.5 text-right font-semibold text-slate-900 dark:text-slate-100">{{ $idNumber($bill['balance_due']) }}</td>
                                    </tr>
                                @empty
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
            ...
            <div class="flex flex-col gap-2 border-t border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap justify-end gap-2">
                    <button type="button" wire:click="previousVendorPage" @disabled($vendorTableMeta['page'] <= 1) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Previous</button>
                    @php
                    ...
                    @if ($vendorPageStart > 1)
                        <button type="button" wire:click="gotoVendorPage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                        <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                    @endif
                    ...
                    @if ($vendorPageEnd < $vendorTableMeta['pages'])
                        <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                        <button type="button" wire:click="gotoVendorPage({{ $vendorTableMeta['pages'] }})" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">{{ $idNumber($vendorTableMeta['pages']) }}</button>
                    @endif
                    <button type="button" wire:click="nextVendorPage" @disabled($vendorTableMeta['page'] >= $vendorTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
                </div>
            </div>
        </x-admin.panel>
    @endif
        ...
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            ...
            <div class="grid gap-2 border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-2">
                <div class="space-y-3">
                    ...
                    <div class="flex gap-2">
                        <input type="text" wire:model="paymentMethodName" placeholder="{{ __('Method name') }}" class="min-h-9 flex-1 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    ...
                    <div class="space-y-2">
                        @forelse ($paymentMethods as $method)
                            <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-sm font-semibold text-slate-900 dark:border-slate-700/50/80 dark:text-slate-100">{{ $method['name'] }}</div>
                        @empty
                            <p class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-sm text-slate-500 dark:border-slate-700/50/80 dark:text-slate-400">{{ __('No payment methods yet.') }}</p>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="grid gap-2 sm:grid-cols-2">
                        <input type="text" wire:model="bankCode" placeholder="{{ __('Code') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="bankName" placeholder="{{ __('Bank') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="bankAccountNumber" placeholder="{{ __('Account number') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="text" wire:model="bankAccountName" placeholder="{{ __('Account name') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <p class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-sm text-slate-500 dark:border-slate-700/50/80 dark:text-slate-400">{{ __('No bank accounts yet.') }}</p>
                        @endforelse
                    </div>
                </div>
            </div>
            ...
            <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                <div class="mb-3 flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row">
                        <input type="text" wire:model="expenseTypeName" placeholder="{{ __('Tipe Pengeluaran') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                ...
                <div class="grid gap-2 lg:grid-cols-[minmax(0,1fr)_10rem_minmax(0,12rem)_minmax(0,10rem)]">
                    ...
                    @else
                        <input type="text" wire:model="operationalExpenseType" placeholder="{{ __('Expense type') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    @endif
                    <input type="number" min="0.01" step="0.01" wire:model="operationalExpenseAmount" placeholder="{{ __('Amount') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    <input type="text" wire:model="operationalExpensePaymentMethod" placeholder="{{ __('Payment method') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    <input type="text" wire:model="operationalExpenseBankCode" placeholder="{{ __('Bank code') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                    <textarea wire:model="operationalExpenseDescription" placeholder="{{ __('Description') }}" class="min-h-20 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white lg:col-span-3"></textarea>
                ...
                @if ($expenseTypes !== [])
                    <div class="mt-3 flex flex-wrap gap-2">
                        @foreach ($expenseTypes as $type)
                            <span class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-2.5 py-1 text-xs font-semibold text-slate-700 dark:border-slate-700/50/80 dark:text-slate-200">{{ $type['name'] }}</span>
                        @endforeach
                    </div>
                @endif

                <div class="mt-3 flex flex-col gap-2 border-t border-slate-200/60/80 pt-3 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
                    <div class="flex flex-wrap items-center gap-2 text-sm">
                        <span class="text-slate-600 dark:text-slate-300">Show</span>
                        <span class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3 text-slate-700 dark:border-slate-700/50/80 dark:text-slate-200">10</span>
                        <span class="text-slate-600 dark:text-slate-300">entries</span>
                    ...
                    <div class="flex flex-wrap items-center justify-end gap-2">
                        <input type="date" wire:model.live="operationalExpenseFromDate" aria-label="{{ __('Operational expense from date') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        <input type="date" wire:model.live="operationalExpenseToDate" aria-label="{{ __('Operational expense to date') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                ...
                <div class="mt-3 flex flex-col gap-2 border-t border-slate-200/60/80 pt-3 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-col gap-2 sm:flex-row sm:items-center">
                        ...
                        <input id="toko-payment-history-search" type="search" wire:model.live.debounce.250ms="paymentHistorySearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                        @if ($canExport)
            ...
            <div class="grid gap-2 px-4 py-4 lg:grid-cols-2">
                <div>
                    ...
                    <div class="mt-3 space-y-2">
                        ...
                        @empty
                            <p class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-sm text-slate-500 dark:border-slate-700/50/80 dark:text-slate-400">{{ __('No POS invoices yet.') }}</p>
                        @endforelse
                    </div>
                </div>
        ...
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            ...
            <div class="grid gap-2 p-3 sm:grid-cols-2">
                ...
                @foreach ($quickActions as $action)
                    <a href="{{ $action['href'] }}" class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-sm hover:bg-slate-50 dark:border-slate-700/50/80 dark:hover:bg-slate-900">
    ...
    <div class="flex flex-col gap-4 lg:flex-row lg:items-start" x-data="{ barcodeFocus: true }" @keydown.window="if($event.key === 'F2') { $refs.barcodeInput.focus(); $event.preventDefault(); }">
        ...
        <div class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/40 dark:bg-black/60 transition-all" wire:transition>
            <div class="w-full max-w-sm scale-100 rounded-3xl bg-white p-8 shadow-[0_0_40px_-10px_rgba(0,0,0,0.1)] transition-all dark:bg-slate-900 dark:shadow-[0_0_40px_-10px_rgba(0,0,0,0.5)] border border-slate-200 dark:border-slate-800">
                <div class="flex flex-col items-center text-center">
                    ...
                    <div class="mt-6 w-full space-y-3">
                        ...
                        <a href="{{ $lastCreatedInvoice['print_url'] }}" target="_blank" class="flex w-full items-center justify-center gap-2 rounded-2xl border border-slate-200/60 bg-white/50  px-4 py-3 text-sm font-bold text-slate-700 shadow-sm transition-all dark:border-slate-700/50 dark:bg-slate-800 dark:text-slate-200 dark:hover:bg-slate-700">
                            <x-heroicon-s-printer class="h-5 w-5" />
                            {{ __('Cetak Nota (A4 / A5)') }}
                        </a>
                    </div>
                    
                    <div class="mt-6 w-full pt-4 border-t border-slate-200/60 dark:border-slate-700/50">
        ...
        <div class="flex-1 space-y-4">
            ...
            <x-admin.panel class="p-4 shadow-sm border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
                ...
                >
                    ...
                    <div 
                        ...
                        style="display: none;" 
                        class="absolute z-50 w-full mt-1.5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md dark:border-slate-700 shadow-xl overflow-hidden"
                    >
                        <div class="max-h-60 overflow-y-auto p-1">
                            <template x-for="(opt, index) in filteredOptions" :key="opt.id">
                                <div 
                                    ...
                                    class="px-4 py-3.5.5 text-sm cursor-pointer rounded-lg transition-colors flex items-center justify-between group"
                                >
            ...
            <!-- CART TABLE -->
            <x-admin.panel class="overflow-hidden border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900 shadow-sm">
                <div class="border-b border-slate-200/60 px-4 py-3 dark:border-slate-700/50">
                    <h3 class="text-sm font-semibold text-slate-900 dark:text-slate-50">{{ __('Keranjang Transaksi') }}</h3>
                </div>
                <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 min-h-[300px]">
        ...
        <div class="w-full shrink-0 lg:w-96 space-y-4 sticky top-6">
            ...
            <x-admin.panel class="p-4 border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900 shadow-sm bg-gradient-to-b from-slate-50/50 to-white dark:from-slate-900/50 dark:to-slate-950">
                <!-- CUSTOMER & INVOICE NO -->
                <div class="flex items-center justify-between mb-4 pb-4 border-b border-slate-200/60 dark:border-slate-700/50 gap-2">
                    <div class="flex-1">
                ...
                <div class="mt-5 space-y-2.5 text-sm px-1">
                    ...
                    <div class="flex justify-between items-center border-t border-slate-200/60 pt-3 mt-3 dark:border-slate-700/50">
                ...
                <!-- PAYMENT METHODS -->
                <div class="mt-5 pt-5 border-t border-slate-200/60 dark:border-slate-700/50">
                ...
                @if ($salePaymentStatus === 'paid' && str($salePaymentMethod)->lower()->contains('cash'))
                    <div class="mt-4 p-3 rounded-xl bg-slate-100 dark:bg-slate-900/50 border border-slate-200/80 dark:border-slate-700/60 bg-slate-50/50 dark:bg-slate-900/50 hover:bg-white dark:hover:bg-slate-800 focus:bg-white dark:focus:bg-slate-900 ">
    ...
    <x-admin.panel class="mt-4">
        <div class="px-4 py-4">
            ...
            <div class="mt-3 grid gap-2 lg:grid-cols-[minmax(0,1fr)_9rem_minmax(0,11rem)_minmax(0,9rem)_minmax(0,9rem)_auto]">
                ...
                <input type="number" min="0.01" step="0.01" wire:model="invoicePaymentAmount" placeholder="{{ __('Amount') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="text" wire:model="invoicePaymentMethod" placeholder="{{ __('Method') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="text" wire:model="invoicePaymentBankCode" placeholder="{{ __('Bank') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                <input type="text" wire:model="invoicePaymentReference" placeholder="{{ __('Reference') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
        ...
        <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            ...
            <div class="mt-3 grid gap-2 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)_auto]">
                ...
                <textarea wire:model="cancelInvoiceReason" rows="1" placeholder="{{ __('Reason') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white"></textarea>
    ...
    <x-admin.panel class="mt-4 border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900 shadow-sm">
        <div class="border-b border-slate-200/60 px-4 py-4 dark:border-slate-700/50">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex items-center gap-2">
                    <div class="relative">
                        ...
                        <input id="toko-sales-search" type="search" wire:model.live.debounce.250ms="salesSearch" placeholder="Cari transaksi..." class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 pl-9 text-sm shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-900 dark:text-white">
                    </div>
                    @if ($canExport)
            ...
            @if ($salesInvoiceDetail)
                <div class="mt-4 rounded-xl border border-primary-200 bg-primary-50/70 p-4 shadow-sm dark:border-primary-900/50 dark:bg-primary-900/20">
                    ...
                    <div class="mt-4 grid gap-3 grid-cols-2 md:grid-cols-4">
                        <div class="rounded-lg border border-white/60 bg-white/60 px-4 py-3.5 shadow-sm dark:border-slate-800/60 dark:bg-slate-900/40">
                    ...
                    <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 rounded-xl border border-slate-200/50 bg-white shadow-sm dark:border-slate-800/50 dark:bg-slate-950">
                        <table class="min-w-full divide-y divide-slate-100 text-sm dark:divide-slate-800">
        ...
        <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
            ...
            <div class="border-t border-slate-200/60/80 px-4 py-3 dark:border-slate-700/50/80 bg-slate-50/30 dark:bg-slate-900/30">
    ...
    <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
        ...
        <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div class="flex items-center gap-2">
                ...
                <input id="toko-delivery-letter-search" type="search" wire:model.live.debounce.250ms="deliveryLetterSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
            </div>
        </div>

        <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4 p-3">
            <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                <thead class="bg-slate-50 dark:bg-slate-900">
                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
        ...
        <div class="flex flex-col gap-2 border-t border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex flex-wrap justify-end gap-2">
                <button type="button" wire:click="previousDeliveryLetterPage" @disabled($deliveryLetterTableMeta['page'] <= 1) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Previous</button>
                @php
                ...
                @if ($deliveryLetterPageStart > 1)
                    <button type="button" wire:click="gotoDeliveryLetterPage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                    <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                @endif
                ...
                @endif
                <button type="button" wire:click="nextDeliveryLetterPage" @disabled($deliveryLetterTableMeta['page'] >= $deliveryLetterTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
            </div>
        </div>
    </x-admin.panel>
    @endif
    ...
    <div class="grid gap-2 xl:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            <div class="border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
                <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Inventory Movements') }}</h2>
            ...
            <div class="flex flex-wrap gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[minmax(0,1fr)_8rem_minmax(0,10rem)_auto]">
                <x-forms.tom-select
                ...
                <button type="button" wire:click="recordInventoryReturn" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900">
                    <x-heroicon-m-arrow-uturn-left class="h-5 w-5" />
                    <span>{{ __('Record Return') }}</span>
                </button>
            </div>

            <div id="toko-stock-in" class="relative grid scroll-mt-24 gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[minmax(0,1fr)_8rem_8rem_minmax(0,9rem)_minmax(0,1fr)_auto]">
                ...
                <button type="button" wire:click="recordManualStockMovement" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900">
                    <x-heroicon-m-check class="h-5 w-5" />
                    <span>{{ __('Record Stock') }}</span>
                </button>
            </div>

            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_auto]">
                <div>
                ...
                <button type="button" wire:click="cancelStockMovement" wire:confirm="{{ __('Cancel this stock movement with reversal?') }}" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl bg-rose-600 px-4 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-700">
                    <x-heroicon-m-x-mark class="h-5 w-5" />
            ...
            <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    ...
                    <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                        <thead class="bg-slate-50 dark:bg-slate-900">
                            <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                ...
                                <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Type') }}</th>
                                <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Reference') }}</th>
                                <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Qty') }}</th>
                                <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Unit Cost') }}</th>
                                <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Source') }}</th>
                ...
                <div class="flex flex-col gap-2 border-t border-slate-200/60/80 px-1 py-3 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div class="flex flex-wrap items-center gap-1">
                        ...
                        @if ($inventoryMovementPageStart > 1)
                            ...
                            @if ($inventoryMovementPageStart > 2)
                                <span class="px-2 text-sm text-slate-500 dark:text-slate-400 font-medium">...</span>
                            @endif
                        @endif
        ...
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            <div class="border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
                <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Toko Reports') }}</h2>
                        ...
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50/50 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:bg-slate-900 dark:text-slate-400">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    ...
                                    <th scope="col" class="px-4 py-3.5 text-left">{{ __('Reference') }}</th>
                                    ...
                                    <th scope="col" class="px-4 py-3.5 text-left">{{ __('Notes') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                                @forelse ($productMovementReportRows as $movement)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        ...
                                        <td class="px-4 py-3.5">
                                            ...
                                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ $movement['sku'] }}</p>
                                        </td>
                                        <td class="px-4 py-3.5">
                                            <span class="rounded-xl bg-slate-100 px-2 py-1 text-xs font-semibold uppercase text-slate-700 dark:bg-slate-800 dark:text-slate-200">{{ $movement['type'] }}</span>
                                        </td>
                                ...
                                @empty
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        <td colspan="8" class="px-3 py-6 text-center text-sm text-slate-500 dark:text-slate-400 font-medium">{{ __('No product movements in this period.') }}</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
    ...
    <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
        <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Quotation Desk') }}</h2>
        ...
        <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_8rem_10rem_auto]">
            <x-forms.tom-select
            ...
            <button type="button" wire:click="addToQuotationCart" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900">
                <x-heroicon-m-plus class="h-5 w-5" />
                <span>{{ __('Add') }}</span>
            </button>
        </div>
        ...
        <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="toko-quotation-search" type="search" wire:model.live.debounce.250ms="quotationSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                </div>
            </div>
            ...
            <div class="mt-3 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap gap-2">
                    <button type="button" wire:click="previousQuotationPage" @disabled($quotationTableMeta['page'] <= 1) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Previous</button>
                    @php
                    ...
                    @if ($quotationPageStart > 1)
                        <button type="button" wire:click="gotoQuotationPage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                    @endif
                    @for ($pageNumber = $quotationPageStart; $pageNumber <= $quotationPageEnd; $pageNumber++)
                        <button
                            ...
                            @class([
                                ...
                                'border-slate-200/60/80 text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900' => $quotationTableMeta['page'] !== $pageNumber,
                            ])
                        >{{ $pageNumber }}</button>
                    @endfor
                    @if ($quotationPageEnd < $quotationTableMeta['pages'])
                        <button type="button" wire:click="gotoQuotationPage({{ $quotationTableMeta['pages'] }})" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">{{ $idNumber($quotationTableMeta['pages']) }}</button>
                    @endif
                    <button type="button" wire:click="nextQuotationPage" @disabled($quotationTableMeta['page'] >= $quotationTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
                </div>
            </div>
        </div>
    </x-admin.panel>
    ...
    <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
        <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Purchase Receiving') }}</h2>
        ...
        <div class="flex flex-wrap gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
            <a href="#toko-purchase-create" class="inline-flex min-h-9 items-center gap-2 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">
                <x-heroicon-o-plus-circle class="h-5 w-5" />
                <span>{{ __('Buat Pembelian') }}</span>
            </a>
            <a href="#toko-purchase-transactions" class="inline-flex min-h-9 items-center gap-2 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">
                <x-heroicon-o-clipboard-document-list class="h-5 w-5" />
                <span>{{ __('Data Transaksi') }}</span>
            </a>
            <a href="#toko-purchase-ap" class="inline-flex min-h-9 items-center gap-2 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">
                <x-heroicon-o-banknotes class="h-5 w-5" />
                <span>{{ __('Hutang') }}</span>
            </a>
            <a href="#toko-purchase-recap" class="inline-flex min-h-9 items-center gap-2 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-sm font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">
                <x-heroicon-o-chart-bar-square class="h-5 w-5" />
                <span>{{ __('Rekap Pembelian') }}</span>
            </a>
        </div>

        <div id="toko-purchase-create" class="grid scroll-mt-24 gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)_8rem_10rem_auto]">
            <x-forms.tom-select
            ...
            <button type="button" wire:click="addToPurchaseCart" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-4 py-3.5 text-sm font-semibold text-slate-800 shadow-sm hover:bg-slate-50 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-slate-100 dark:hover:bg-slate-900">
                <x-heroicon-m-plus class="h-5 w-5" />
                <span>{{ __('Add') }}</span>
            </button>
        </div>

        <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 lg:grid-cols-[10rem_minmax(0,1fr)_10rem_minmax(0,1fr)]">
            <input
                type="date"
            ...
            <textarea
                ...
                class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white lg:col-span-4"
            ></textarea>
        </div>
        ...
        <div id="toko-purchase-ap" class="scroll-mt-24 border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
        ...
        <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            ...
            <div class="mt-3 grid gap-2 lg:grid-cols-[minmax(0,1fr)_12rem_auto]">
                ...
                <input type="number" min="0" step="0.01" wire:model="vendorBillPaymentAmount" placeholder="{{ __('Amount') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
        ...
        <div class="border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            ...
            <div class="mt-3 grid gap-2 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)_auto]">
                ...
                <textarea wire:model="cancelPurchaseReason" rows="1" placeholder="{{ __('Reason') }}" class="min-h-9 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white"></textarea>
                <button type="button" wire:click="cancelPurchase" class="inline-flex min-h-9 items-center justify-center gap-2 rounded-xl bg-rose-600 px-4 py-3.5 text-sm font-semibold text-white shadow-sm hover:bg-rose-700">
                    <x-heroicon-m-x-mark class="h-5 w-5" />
                    <span>{{ __('Cancel') }}</span>
                </button>
            </div>
        ...
        <div id="toko-purchase-recap" class="scroll-mt-24 border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
        ...
        <div id="toko-purchase-transactions" class="scroll-mt-24 border-t border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="mt-3 flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <input id="toko-purchase-search" type="search" wire:model.live.debounce.250ms="purchaseSearch" class="min-h-9 w-64 rounded-xl border-slate-200 dark:border-slate-700/50 bg-white text-sm text-slate-900 shadow-sm focus:border-primary-500 focus:ring-primary-500 dark:border-slate-700/50/80 dark:bg-slate-950 dark:text-white">
                </div>
            </div>
            @if ($purchaseBillDetail)
                <div class="mt-3 rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-slate-50 p-2 dark:border-slate-700/50/80 dark:bg-slate-900/60">
                    <div class="flex flex-col gap-2 lg:flex-row lg:items-start lg:justify-between">
                        <div>
                    ...
                    <div class="mt-3 grid gap-2 text-sm md:grid-cols-3 xl:grid-cols-6">
                        ...
                        <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 bg-white p-2 text-right dark:border-slate-700/50/80 dark:bg-slate-950">
            ...
            <div class="mt-3 flex flex-col gap-2 border-t border-slate-200/60/80 pt-3 dark:border-slate-700/50/80 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap justify-end gap-2">
                    <button type="button" wire:click="previousPurchasePage" @disabled($purchaseTableMeta['page'] <= 1) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Previous</button>
                    @php
                    ...
                    @if ($purchasePageStart > 1)
                        <button type="button" wire:click="gotoPurchasePage(1)" class="inline-flex min-h-9 min-w-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900">1</button>
                        <span class="inline-flex min-h-9 items-center justify-center px-1 text-xs font-semibold text-slate-400">...</span>
                    @endif
                    ...
                    @endif
                    <button type="button" wire:click="nextPurchasePage" @disabled($purchaseTableMeta['page'] >= $purchaseTableMeta['pages']) class="inline-flex min-h-9 items-center justify-center rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-3 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:text-slate-400 disabled:opacity-60 dark:border-slate-700/50/80 dark:text-slate-200 dark:hover:bg-slate-900 dark:disabled:text-slate-500">Next</button>
                </div>
            </div>
        </div>
    </x-admin.panel>
    ...
    <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
        <div class="flex flex-col gap-2 border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Legacy Import Preview') }}</h2>
        ...
        <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-3.5 text-xs text-slate-600 dark:border-slate-700/50/80 dark:text-slate-300 sm:grid-cols-3">
            @foreach ($dumpSources as $source)
                <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 dark:border-slate-700/50/80">
        ...
        @else
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 xl:grid-cols-[1fr_1.4fr]">
                <div class="grid gap-2 sm:grid-cols-2">
                    <div class="rounded-lg border border-slate-200/60/80 bg-slate-50 p-2 dark:border-slate-700/50/80 dark:bg-slate-900">
                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Mapped Tables') }}</p>
                        <p class="mt-2 text-base font-bold tracking-tight text-slate-900 dark:text-white">
                            {{ $idNumber($legacyPreview['totals']['mapped_tables']) }} / {{ $idNumber($legacyPreview['totals']['legacy_tables']) }}
                        </p>
                        <p class="mt-1 text-xs text-slate-500 dark:text-slate-400 font-medium">{{ $idNumber($legacyPreview['totals']['mapped_rows']) }} {{ __('rows covered') }}</p>
                    </div>
                ...
                <div class="rounded-lg border border-slate-200/60/80 bg-white p-2 dark:border-slate-700/50/80 dark:bg-slate-950">
                    <div class="flex items-center justify-between gap-2">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Migration Coverage') }}</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy tables that still need mapping are shown first by row count.') }}</p>
                        </div>
                    ...
                    @if ($legacyPreview['coverage']['unmapped'] !== [])
                        <div class="mt-3 grid gap-2 sm:grid-cols-2">
                            @foreach (array_slice($legacyPreview['coverage']['unmapped'], 0, 8) as $gap)
                                <div class="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3.5 text-xs dark:border-amber-900/60 dark:bg-amber-950/40">
                                    <div class="flex items-center justify-between gap-2">
                    ...
                    @else
                        <p class="mt-3 rounded-xl border border-emerald-100 shadow-sm bg-emerald-50/20 bg-emerald-50 px-4 py-3.5 text-sm text-emerald-800 dark:border-emerald-900/60 dark:bg-emerald-950/40 dark:text-emerald-200">
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 sm:grid-cols-2 xl:grid-cols-4">
                @foreach ($legacyPreview['readiness'] as $readiness)
                    <div class="rounded-lg border border-slate-200/60/80 bg-slate-50 p-2 dark:border-slate-700/50/80 dark:bg-slate-900">
                        <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ $readiness['label'] }}</p>
                        <div class="mt-2 flex items-end justify-between gap-2">
                            <div>
                                <p class="text-base font-bold tracking-tight text-slate-900 dark:text-white">{{ $idNumber($readiness['ready']) }}</p>
                                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('ready') }}</p>
                            </div>
                            <div class="text-right">
                                ...
                                <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('issues') }}</p>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="grid gap-2 border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80 xl:grid-cols-2">
                <div>
                    <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Existing Data Collisions') }}</h3>
                    ...
                    <div class="mt-3 grid gap-2 sm:grid-cols-3">
                        @foreach ($legacyPreview['collisions'] as $collision)
                            <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 dark:border-slate-700/50/80">
                                <p class="text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ $collision['count'] === 1 ? __('Collision') : __('Collisions') }}</p>
                                ...
                                @if ($collision['keys'] !== [])
                                    <p class="mt-1 truncate text-xs text-slate-500 dark:text-slate-400 font-medium">{{ implode(', ', array_slice($collision['keys'], 0, 3)) }}</p>
                                @endif
                            </div>
                        @endforeach
                    </div>
                ...
                <div>
                    <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Dry-run Master Import') }}</h3>
                    <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('No records are written during this preview.') }}</p>
                    ...
                    <div class="mt-3 grid gap-2 sm:grid-cols-2">
                        @foreach ([
                            ...
                            <div class="rounded-2xl border border-slate-200/60 shadow-sm transition-all hover:shadow-md/80 px-4 py-3.5 text-xs dark:border-slate-700/50/80">
            ...
            @if ($latestHistoricalReconciliation !== [])
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Historical Reconciliation') }}</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('Latest historical import totals compared against target records.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50 dark:bg-slate-900">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Bucket') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy Count') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Target Count') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy Total') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Target Total') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Gap') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Status') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                @foreach ($latestHistoricalReconciliation as $bucket)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        <td class="px-4 py-3.5 font-semibold text-slate-900 dark:text-slate-100">{{ __($bucket['label']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($bucket['legacy_count']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($bucket['target_count']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $bucket['legacy_total'] === null ? '-' : ($bucket['legacy_total']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $bucket['target_total'] === null ? '-' : ($bucket['target_total']) }}</td>
            ...
            @if ($latestMonthlyHistoricalReconciliation !== [])
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Monthly Report Reconciliation') }}</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy monthly report totals compared with imported sales, purchases, expenses, and net income.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50 dark:bg-slate-900">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Month') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Sales') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Purchases') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Expenses') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Net Income') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Gap') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Status') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                @foreach ($latestMonthlyHistoricalReconciliation as $month)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        <td class="px-4 py-3.5 font-semibold text-slate-900 dark:text-slate-100">{{ $month['month'] }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($month['target']['sales']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($month['target']['purchases']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($month['target']['operational_expenses']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($month['target']['net_income']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">
            ...
            @if ($latestCashBankHistoricalReconciliation !== [])
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <div class="flex flex-col gap-1 sm:flex-row sm:items-end sm:justify-between">
                        <div>
                            <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Cash/Bank Reconciliation') }}</h3>
                            <p class="text-xs text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy payment method and bank account totals compared with imported payment metadata.') }}</p>
                        </div>
                    </div>
                    ...
                    <div class="mt-3 overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
                        <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                            <thead class="bg-slate-50 dark:bg-slate-900">
                                <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                    <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Group') }}</th>
                                    <th class="px-4 py-3.5 text-left text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Account') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Legacy Total') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Target Total') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Gap') }}</th>
                                    <th class="px-4 py-3.5 text-right text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:text-slate-400 font-medium">{{ __('Status') }}</th>
                            ...
                            <tbody class="divide-y divide-slate-100 dark:divide-slate-800">
                                @foreach ($latestCashBankHistoricalReconciliation as $bucket)
                                    <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                        <td class="px-4 py-3.5 font-semibold text-slate-900 dark:text-slate-100">{{ __($bucket['group']) }}</td>
                                        <td class="px-4 py-3.5 text-slate-600 dark:text-slate-300">{{ $bucket['bucket'] }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($bucket['legacy_total']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($bucket['target_total']) }}</td>
                                        <td class="px-4 py-3.5 text-right text-slate-600 dark:text-slate-300">{{ $idNumber($bucket['gap']) }}</td>
                                        <td class="px-4 py-3.5 text-right">
                                            <span class="rounded-xl px-2 py-1 text-xs font-semibold {{ $bucket['matched'] ? 'bg-emerald-50 text-emerald-700 dark:bg-emerald-950/50 dark:text-emerald-200' : 'bg-amber-50 text-amber-700 dark:bg-amber-950/50 dark:text-amber-200' }}">
                                                {{ $bucket['matched'] ? __('Matched') : __('Review') }}
                                            </span>
            ...
            @if ($legacyPreview['issues'] !== [])
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Validation Issues') }}</h3>
                    <div class="mt-2 grid gap-2 lg:grid-cols-2">
                        @foreach (array_slice($legacyPreview['issues'], 0, 12) as $issue)
                            <p class="rounded-xl border border-amber-200 bg-amber-50 px-4 py-3.5 text-sm text-amber-800 dark:border-amber-900/60 dark:bg-amber-950/50 dark:text-amber-200">{{ $issue }}</p>
                        @endforeach
                    </div>
            ...
            @if ($recentRuns !== [])
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Recent Imports') }}</h3>
            ...
            @if ($cutoverReadiness)
                <div class="border-b border-slate-200/60/80 px-4 py-4 dark:border-slate-700/50/80">
                    <div class="flex items-center justify-between gap-2">
                        <h3 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Cutover Readiness') }}</h3>
                        <div class="flex items-center gap-2">
            ...
            <div class="overflow-x-auto rounded-2xl border border-slate-200/60 dark:border-slate-700/50 shadow-sm mt-4">
                <table class="min-w-full divide-y divide-slate-200/60 text-sm dark:divide-slate-700/50">
                    <thead class="bg-slate-50/50 text-[10px] font-bold uppercase tracking-wider text-slate-500 dark:bg-slate-900 dark:text-slate-400">
                        <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                            <th scope="col" class="px-4 py-3.5 text-left">{{ __('Legacy Table') }}</th>
                            <th scope="col" class="px-4 py-3.5 text-left">{{ __('Target') }}</th>
                            <th scope="col" class="px-4 py-3.5 text-right">{{ __('Rows') }}</th>
                            <th scope="col" class="px-4 py-3.5 text-left">{{ __('Sample') }}</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-700">
                        @foreach ($legacyPreview['tables'] as $table => $info)
                            <tr class="group hover:bg-white dark:hover:bg-slate-800/80 hover:shadow-sm transition-all duration-300">
                                <td class="px-4 py-3.5 font-mono text-xs text-slate-900 dark:text-slate-100">{{ $table }}</td>
                                <td class="px-4 py-3.5 text-slate-700 dark:text-slate-200">{{ $info['target'] }}</td>
                                <td class="px-4 py-3.5 text-right font-semibold text-slate-900 dark:text-slate-100">{{ $idNumber($info['rows']) }}</td>
                                <td class="max-w-md px-4 py-3.5 text-xs text-slate-600 dark:text-slate-300">
    ...
    <div class="grid gap-2 xl:grid-cols-[minmax(0,1fr)_22rem]">
        <x-admin.panel class="border-0 ring-1 ring-slate-200/60 dark:ring-slate-700/50 shadow-sm  bg-white dark:bg-slate-900">
            <div class="border-b border-slate-200/60/80 px-4 py-3.5 dark:border-slate-700/50/80">
                <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Add-on Scope') }}</h2>
            </div>
            ...
            <div class="divide-y divide-slate-200 dark:divide-slate-700">
                @foreach ([
                    ...
                    <div class="grid gap-2 px-4 py-3.5 sm:grid-cols-[12rem_minmax(0,1fr)]">
        ...
        <x-admin.panel class="p-3">
            <div class="space-y-4">
                <div>
                    <h2 class="text-sm font-bold tracking-tight text-slate-900 dark:text-white">{{ __('Premium Boundary') }}</h2>
                ...
                <div class="rounded-lg border border-slate-200/60/80 bg-slate-50 p-2 text-sm text-slate-700 dark:border-slate-700/50/80 dark:bg-slate-900 dark:text-slate-200">
                ...
                @if (! $canManage)
                    <p class="rounded-lg border border-slate-200/60/80 bg-white p-2 text-sm text-slate-600 dark:border-slate-700/50/80 dark:bg-slate-900 dark:text-slate-300">
